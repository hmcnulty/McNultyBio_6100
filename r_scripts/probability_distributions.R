...
z
## create and plot a density function
x <- 1:100
frog_density <- dnorm(x = x, mean = 26.8083333, sd = 2.1806759)
qplot(x, frog_density, geom="line")
# gamma density distribution
z <- fitdistr(frog_data, "gamma")
frog_gamma <- dgamma(x, shape = 147.195171, rate = 5.490650)
qplot(x, frog_gamma, geom="line")
# adding an outlier to see skew
new_frog_data <- c(frog_data, 0.05)
z <- fitdistr(new_frog_data, "gamma")
z
new_frog_gamma <- dgamma(x, shape = 0.7953050, rate = 0.0345992)
qplot(x, new_frog_gamma, geom="line")
